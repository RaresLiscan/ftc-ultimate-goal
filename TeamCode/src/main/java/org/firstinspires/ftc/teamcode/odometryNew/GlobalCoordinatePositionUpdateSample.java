    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Vertical left encoder position", verticalLeft.getCurrentPosition() * globalPositionUpdate.verticalLeftEncoderPositionMultiplier);
            telemetry.addData("Vertical right encoder position", verticalRight.getCurrentPosition() * globalPositionUpdate.verticalRightEncoderPositionMultiplier);
            telemetry.addData("horizontal encoder position", horizontal.getCurrentPosition() * globalPositionUpdate.normalEncoderPositionMultiplier);

            telemetry.addData("Vertical robotEncoderWheelDistance: ", globalPositionUpdate.robotEncoderWheelDistance);
